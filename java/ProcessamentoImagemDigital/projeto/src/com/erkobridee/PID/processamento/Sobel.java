 ...
 * 15/11/2005 <br>
 * <b>Descrição:</b><br>
 * Classe que implementa os calculos do filtro de Sobel
 */
public class Sobel {    
...
//  -----------------------------------------------------------
	...
	/**
	 * Método que calcula da função de Sobel
	 * 
	 * F: |Gx| + |Gy|
	 * 
	 * @param int x
	...
	/**
	 * Método que calcula o componente do eixo x do calculo
	 * 
	 * @param int x
	 * @param int y
	 * @return Color
	...
	private Color Gx( int x, int y ) {
	    ...
	    double[][] mascara = {{-1,-2,-1},{0,0,0},{1,2,1}};
	...
	/**
	 * Método que calcula o componente do eixo y do calculo
	 * 
	 * @param int x
	 * @param int y
	 * @return Color
	...
	private Color Gy( int x, int y ) {
	    ...
	    double[][] mascara = {{-1,0,1},{-2,0,2},{-1,0,1}};
	...
	/**
	 * Método que calcula uma determinda mascara em uma região especifica da
	 * da imagem
	 *  
	 * @param int x
	 * @param int y
