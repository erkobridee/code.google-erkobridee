 ...
 * 
 * <br><br>
 * Classe responsável pelo código de aplicação de mascara 
...
//-----------------------------------------------------------	
	/**
	 * Método que aplica a mascara na imagem
	 * 
	...
	*/
	// MÉTODO 16 PIXELS POR INTERAÇÃO
	/*
	public BufferedImage doWork() {
	    // criando um novo buffer para saida do resultado
	    this.setBiResultado( new BufferedImage(this.getBiOriginal().getWidth(), this.getBiOriginal().getHeight(), this.getBiOriginal().getType()) );
	...
	*/
	// MÉTODO COM 16 THREADS, infelizmente foi mais lento =(
	/*
	public BufferedImage doWork() {
	    // criando um novo buffer para saida do resultado
	    this.setBiResultado( new BufferedImage(this.getBiOriginal().getWidth(), this.getBiOriginal().getHeight(), this.getBiOriginal().getType()) );
		...
		// instânciando objetos de processamento de áreas da imagem
		...
		quadro.setMascara( this.getMascara() );
			// informa se deve ser realizada a divisão
		quadro.setFlagDivide( this.isFlagDivide() );
			// informa se a imagem está em escala de cinza
		...
		// determina a área a ser processada por cada quadro
...
//-----------------------------------------------------------
	...
	/**
	 * Método que converte a mascara de double para um vetor float
	 * @param mascara
	 * @return
	 */
